 ...
 *  in the panel itself.
 */
public class ObserverAgentModel extends AgentModelSwarm {
	int display;
...
//			}
			params = new String[] {
					...
					"harvest_adjustment",
					"state_good", "ad_plots","max_coop_radius_brn"
			};
		}
...
//			System.out.println("Eligible List Graph being printed" + eligibleGenders);
	...
	private JButton createButton(String label, final String method) {
		final ObserverAgentModel me = this;
		JButton button = new JButton(label);
		button.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent ae) {
				try {
					Method m = ObserverAgentModel.class.getMethod(method);
					m.invoke(me);
	...
	public static void main(String[] args) {
		...
		final ObserverAgentModel agentModelSwarm = new ObserverAgentModel();
